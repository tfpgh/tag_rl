...
class TagEnvironment:
    ...
    def _build_agent_model_indices(self, prefix: str) -> AgentModelIndices:
        ...
        right_wheel_body_id = mujoco.mj_name2id(
            self.mj_model, mujoco.mjtObj.mjOBJ_BODY, f"{prefix}_right_wheel"
        )
    ...
    def step_physics(
        ...
        info = TagEnvironmentStepInfo(
            ...
            distance=distance,
            step_count=step_count,
            chaser_forward_velocity=safe_chaser_forward_velocity,
            chaser_angular_velocity=_finite_or(chaser.angular_velocity, jnp.float32(0.0)),
            evader_forward_velocity=safe_evader_forward_velocity,
            evader_angular_velocity=_finite_or(evader.angular_velocity, jnp.float32(0.0)),
