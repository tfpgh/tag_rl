...
PARAM_SPECS: tuple[tuple[str, ParamBounds], ...] = (
    ("track_width_scale", ParamBounds(0.88, 1.20)),
    ("wheel_longitudinal_offset", ParamBounds(-0.015, 0.015)),
    ("wheel_radius_scale", ParamBounds(0.88, 1.12)),
    ("wheel_slide_friction_scale", ParamBounds(0.60, 3.0)),
    ("wheel_slide_friction_balance", ParamBounds(-0.20, 0.20)),
    ("wheel_torsional_friction_scale", ParamBounds(0.15, 1.80)),
    ("wheel_rolling_friction_scale", ParamBounds(0.15, 1.80)),
    ("caster_radius_scale", ParamBounds(0.80, 1.20)),
    ("caster_offset_x", ParamBounds(-0.020, 0.015)),
    ("caster_slide_friction_scale", ParamBounds(0.50, 1.75)),
    ("caster_torsional_friction_scale", ParamBounds(0.50, 1.75)),
    ("wheel_joint_damping_scale", ParamBounds(0.30, 1.75)),
    ("wheel_joint_damping_balance", ParamBounds(-0.20, 0.20)),
    ("wheel_joint_frictionloss_scale", ParamBounds(0.30, 1.75)),
    ("wheel_joint_frictionloss_balance", ParamBounds(-0.20, 0.20)),
    ("wheel_armature_scale", ParamBounds(0.35, 2.0)),
    ("motor_strength_scale", ParamBounds(0.70, 1.50)),
    ("back_emf_scale", ParamBounds(0.50, 1.50)),
    ("motor_balance", ParamBounds(-0.20, 0.20)),
    ("motor_deadzone", ParamBounds(0.0, 0.10)),
    ("motor_time_constant_seconds", ParamBounds(0.0, 0.30)),
    ("com_offset_x", ParamBounds(-0.020, 0.020)),
    ("command_delay_substeps", ParamBounds(0.0, 20.0)),
    ("observation_delay_substeps", ParamBounds(0.0, 10.0)),
)
