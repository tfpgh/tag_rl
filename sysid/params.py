...
PARAM_SPECS: tuple[tuple[str, ParamBounds], ...] = (
    ("track_width_scale", ParamBounds(0.85, 1.20)),
    ("wheel_longitudinal_offset", ParamBounds(-0.020, 0.020)),
    ("wheel_radius_scale", ParamBounds(0.85, 1.20)),
    ("wheel_slide_friction_scale", ParamBounds(0.40, 3.00)),
    ("wheel_slide_friction_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_torsional_friction_scale", ParamBounds(0.10, 2.20)),
    ("wheel_rolling_friction_scale", ParamBounds(0.05, 2.00)),
    ("caster_radius_scale", ParamBounds(0.75, 1.30)),
    ("caster_offset_x", ParamBounds(-0.025, 0.020)),
    ("caster_slide_friction_scale", ParamBounds(0.30, 2.00)),
    ("caster_torsional_friction_scale", ParamBounds(0.30, 2.20)),
    ("wheel_joint_damping_scale", ParamBounds(0.20, 2.20)),
    ("wheel_joint_damping_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_joint_frictionloss_scale", ParamBounds(0.20, 2.00)),
    ("wheel_joint_frictionloss_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_armature_scale", ParamBounds(0.20, 2.50)),
    ("motor_strength_scale", ParamBounds(0.60, 1.80)),
    ("back_emf_scale", ParamBounds(0.60, 1.50)),
    ("motor_balance", ParamBounds(-0.25, 0.25)),
