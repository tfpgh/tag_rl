...
PARAM_SPECS: tuple[tuple[str, ParamBounds], ...] = (
    ("track_width_scale", ParamBounds(0.75, 1.25)),
    ("wheel_longitudinal_offset", ParamBounds(-0.02, 0.02)),
    ("wheel_radius_scale", ParamBounds(0.80, 1.20)),
    ("wheel_slide_friction_scale", ParamBounds(0.35, 3.0)),
    ("wheel_slide_friction_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_torsional_friction_scale", ParamBounds(0.2, 3.0)),
    ("wheel_rolling_friction_scale", ParamBounds(0.2, 3.0)),
    ("caster_radius_scale", ParamBounds(0.70, 1.30)),
    ("caster_offset_x", ParamBounds(-0.02, 0.02)),
    ("caster_slide_friction_scale", ParamBounds(0.2, 3.5)),
    ("caster_torsional_friction_scale", ParamBounds(0.2, 3.5)),
    ("wheel_joint_damping_scale", ParamBounds(0.2, 3.5)),
    ("wheel_joint_damping_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_joint_frictionloss_scale", ParamBounds(0.2, 3.5)),
    ("wheel_joint_frictionloss_balance", ParamBounds(-0.25, 0.25)),
    ("wheel_armature_scale", ParamBounds(0.2, 3.5)),
    ("motor_strength_scale", ParamBounds(0.5, 2.0)),
    ("back_emf_scale", ParamBounds(0.25, 1.5)),
    ("motor_balance", ParamBounds(-0.2, 0.2)),
    ("motor_deadzone", ParamBounds(0.0, 0.2)),
    ("motor_time_constant_seconds", ParamBounds(0.0, 0.2)),
