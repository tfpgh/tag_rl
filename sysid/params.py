...
PARAM_SPECS: tuple[tuple[str, ParamBounds], ...] = (
    ("track_width_scale", ParamBounds(0.90, 1.10)),
    ("wheel_longitudinal_offset", ParamBounds(-0.01, 0.01)),
    ("wheel_radius_scale", ParamBounds(0.90, 1.10)),
    ("wheel_slide_friction_scale", ParamBounds(0.75, 1.50)),
    ("wheel_slide_friction_balance", ParamBounds(-0.10, 0.10)),
    ("wheel_torsional_friction_scale", ParamBounds(0.50, 1.50)),
    ("wheel_rolling_friction_scale", ParamBounds(0.50, 1.50)),
    ("caster_radius_scale", ParamBounds(0.85, 1.15)),
    ("caster_offset_x", ParamBounds(-0.01, 0.01)),
    ("caster_slide_friction_scale", ParamBounds(0.50, 1.75)),
    ("caster_torsional_friction_scale", ParamBounds(0.50, 1.75)),
    ("wheel_joint_damping_scale", ParamBounds(0.50, 1.75)),
    ("wheel_joint_damping_balance", ParamBounds(-0.10, 0.10)),
    ("wheel_joint_frictionloss_scale", ParamBounds(0.50, 1.75)),
    ("wheel_joint_frictionloss_balance", ParamBounds(-0.10, 0.10)),
    ("wheel_armature_scale", ParamBounds(0.50, 1.75)),
    ("motor_strength_scale", ParamBounds(0.80, 1.20)),
    ("back_emf_scale", ParamBounds(0.75, 1.25)),
    ("motor_balance", ParamBounds(-0.10, 0.10)),
    ("motor_deadzone", ParamBounds(0.0, 0.10)),
    ("motor_time_constant_seconds", ParamBounds(0.0, 0.10)),
    ("com_offset_x", ParamBounds(-0.01, 0.01)),
