...
PARAM_SPECS: tuple[tuple[str, ParamBounds], ...] = (
    ...
    ("wheel_slide_friction_scale", ParamBounds(0.60, 1.80)),
    ("wheel_slide_friction_balance", ParamBounds(-0.10, 0.10)),
    ("wheel_torsional_friction_scale", ParamBounds(0.35, 1.80)),
    ("wheel_rolling_friction_scale", ParamBounds(0.35, 1.80)),
    ...
    ("wheel_joint_damping_balance", ParamBounds(-0.15, 0.15)),
    ("wheel_joint_frictionloss_scale", ParamBounds(0.50, 1.75)),
    ("wheel_joint_frictionloss_balance", ParamBounds(-0.15, 0.15)),
    ("wheel_armature_scale", ParamBounds(0.35, 2.0)),
    ("motor_strength_scale", ParamBounds(0.70, 1.30)),
    ("back_emf_scale", ParamBounds(0.75, 1.25)),
    ("motor_balance", ParamBounds(-0.15, 0.15)),
    ("motor_deadzone", ParamBounds(0.0, 0.10)),
    ("motor_time_constant_seconds", ParamBounds(0.0, 0.10)),
    ("com_offset_x", ParamBounds(-0.015, 0.015)),
